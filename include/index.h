...
*/
__host__ __device__ inline int Index_ND_Neig_EO_PlusOne(const int id, const int oddbit,
                                                        const int mu) {
  int x[NDIMS];
  Index_ND_EO(x, id, oddbit);
#ifdef MULTI_GPU
...
/**
        @brief U(id - e_mu), retrieves the neighbor in evenodd lattice index
*/
__host__ __device__ inline int Index_ND_Neig_EO_MinusOne(const int id, const int oddbit,
                                                const int mu) {
  int x[NDIMS];
  Index_ND_EO(x, id, oddbit);
#ifdef MULTI_GPU
